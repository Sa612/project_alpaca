...
module SimpleFormFancyUploads
    class ImagePreviewInput < SimpleForm::Inputs::FileInput
        def input(wrapper_options=nil)
            ...
            out << super
            out << template.image_tag(url, style: 'margin-top: 10px; padding: 10px; border: 1px solid #CCC; border-radius: 3px; width: 300px;') if url
            out.html_safe
        end
...
SimpleForm::Inputs.include(SimpleFormFancyUploads)
